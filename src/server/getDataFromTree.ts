...
function hasFetchDataFunction(instance: React.Component<any>): instance is FetchComponent {
  console.log("instance.fetchData = ",typeof (instance as any).fetchData, (instance as any)['fetchData'])
...
function getPromisesFromTree({
  ...
  walkTree(rootElement, rootContext, (element, instance, context, childContext) => {
    ...
    console.log("examining: ", element, instance)
    if (instance && hasFetchDataFunction(instance)) {
      console.log("found fetch data function")
